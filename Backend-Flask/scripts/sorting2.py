...
keystone_dict = {
    "Alduric": {
        "Alduric": {"Class": "Paladin", "Hconf": 0, "Role": ["Tank", "DPS"], "Tconf": 0}
    },
    "Cardinal": {
        "Flashlight": {"Class": "Paladin", "Hconf": 0, "Role": ["Healer"], "Tconf": 0},
        "Fluke": {"Class": "Hunter", "Hconf": 0, "Role": ["DPS"], "Tconf": 0},
    },
    "Fern": {
        "Fernicus": {
            "Class": "Warrior",
    ...
    "Jmartz": {
        "Calioma": {"Class": "Priest", "Hconf": 0, "Role": ["Healer"], "Tconf": 0},
        "Jmartz": {"Class": "Warrior", "Hconf": 0, "Role": ["Tank", "DPS"], "Tconf": 0},
        "TankyTank": {"Class": "Druid", "Hconf": 0, "Role": ["Tank"], "Tconf": 3},
    },
    "Shelana": {
        "Shellager": {
            "Class": "Monk",
    ...
    "ani": {
        "aniperson": {"Class": "Druid", "Hconf": 0, "Role": ["Tank", "DPS"], "Tconf": 0}
    },
    "arrrgh": {
        "hitehre": {"Class": "Priest", "Hconf": 3, "Role": ["Healer"], "Tconf": 0}
    },
    "paliguy": {
        "pali": {"Class": "Paladin", "Hconf": 0, "Role": ["Tank", "DPS"], "Tconf": 0}
    },
    "sajah": {
        "aythe": {"Class": "Warlock", "Hconf": 0, "Role": ["DPS"], "Tconf": 0},
        "sajah": {"Class": "Druid", "Hconf": 0, "Role": ["DPS"], "Tconf": 0},
        "zabella": {
            "Class": "Paladin",
            "Hconf": 0,
            "Role": ["Tank", "DPS"],
    ...
    "shaloo": {
        "shel": {"Class": "Monk", "Hconf": 0, "Role": ["Tank", "Healer"], "Tconf": 3}
    },
    "trugbug": {"trugers": {"Class": "Rogue", "Hconf": 0, "Role": ["DPS"], "Tconf": 0}},
    "warlockperson": {
        "pewpew": {"Class": "Warlock", "Hconf": 0, "Role": ["DPS"], "Tconf": 0}
    },
}
...
{
    "Callenguan": {
        "Caliel": {"Level": 4, "Dungeon": "Underrot", "Class": "Mage", "Role": ["DPS"]}
    },
    "Trixrontan": {
        "Remian": {
            "Level": 14,
    ...
    "Jomollolana": {
        "Trixsa": {"Level": 16, "Dungeon": "Underrot", "Class": "Mage", "Role": ["DPS"]}
    },
    "Gatlentrax": {
        "Shelen": {
            "Level": 5,
    ...
    "Jomneten": {
        ...
        "Callana": {"Level": 6, "Dungeon": "Uldaman", "Class": "Mage", "Role": ["DPS"]},
        "Sahtrax": {
            "Level": 16,
            "Dungeon": "Neltharus",
            "Class": "Hunter",
