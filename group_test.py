...
print(f"------- NUMBER OF PLAYERS IN THE INITIAL PLAYER POOL: {len(players_list)}\n")
print(f"------- NUMBER OF CHARACTERS IN THE INITIAL CHARACTER POOL: {len(players_list)}\n")
